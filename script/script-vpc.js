    ...
    function crearCajaFormulario(cantidad) {
        ...
        for (let i = 0; i < cantidad; i++) { 
            ...
            <div class="formulario_individual">
                <p class="num_form">VPC ${i + 1}</p>
                <input type="text" class="nombre" placeholder="Nombre de la VPC" required>
    ...
    document.querySelector('#enviar_btn').addEventListener('click', function(event) {
        ...
        if (allValid) {
            ...
            nombre.forEach(function(nombreFuncion, index) {
                ...
                outputDiv.innerHTML += `
<p>
<span class="morado">#VPC ${index + 1}:</span> <br/>
<span class="amarillo">resource</span> "aws_vpc" "${nombre_ipelas}" <span class="amarillo">{</span> <br/>
